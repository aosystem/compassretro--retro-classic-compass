...
import 'package:compassretro/ad_ump_status.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  Future<void> _onApply() async {
    await Model.setThemeImage(_themeImage);
  ...
  Widget _buildThemeImage(AppLocalizations l) {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ListTile(
              title: Text(l.themeImage,style: Theme.of(context).textTheme.bodyMedium),
              contentPadding: EdgeInsets.zero,
              trailing: DropdownButton<int>(
                value: _themeImage,
                items: [
                  DropdownMenuItem(value: 1, child: Text("Retro")),
                  DropdownMenuItem(value: 2, child: Text("Metal")),
                  DropdownMenuItem(value: 3, child: Text("Flower")),
                  DropdownMenuItem(value: 4, child: Text("Leaf")),
                ],
                onChanged: (value) {
                  if (value != null) {
                    setState(() {
